...
{
    public class StoreProcedureFacade<h, k> : Facade
        where h : Entity
        where k : IEntityMapper<h>
    {
        ...
        /// 
        /// </summary>
        public StoreProcedureFacade(string StoredProcedure)
        {
            this.iDataAccess = StoreProcedureDataAccessInjector<GenericDataAccess<h, k>, h>.GetDatabaseInstance("DataAccess", "dataContainer", "unity", StoredProcedure);
        }
        /// <summary>
        /// 
        /// </summary>
